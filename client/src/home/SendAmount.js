 ...
 <div class="container-fluid">
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <ul class="navbar-nav me-auto  ">
       ...
       <li class="nav-item">
         <a class="nav-link" >Account Number: {e.user.account_number}</a>
       </li>
     </ul>
   </div>
                        ...
                        <div class="row pt-3" id="border-btm">
                            ...
                            <div class="col-8">
                                <div class="row justify-content-right">
                                    <div class="col-12">
                                        <p class="mb-0 mr-4 mt-4 text-right">{e.user.email}</p>
                                    </div>
                                </div>
                                <div class="row justify-content-right">
                                    <div class="col-12">
                                        <p class="mb-0 mr-4 text-right">Pay <span class="top-highlight">{ammount}</span> </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-11">
                                        <div class="form-card">
                                            ...
                                            <form onsubmit="event.preventDefault()">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <p class="text-center mb-5" id="below-btn"><a >Use a test card</a></p>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                    ...
                                    <div class="col-11">
                                        <div class="form-card">
                                            ...
                                            <form onsubmit="event.preventDefault()">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="input-group"> <input type="text" id="cr_no" placeholder="0000 0000 0000 0000" minlength="19" maxlength="19" value={useracc_no} onChange={(e)=>{setuser_acc_no(e.target.value)}}/> <label>YOUR ACCOUNT  NUMBER</label> </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="input-group"> <input type="text" id="cr_no" placeholder="0000 0000 0000 0000" minlength="19" maxlength="19" value={accno} onChange={(e)=>{setaccno(e.target.value)}} /> <label>RECIEVERS ACCOUNT NUMBER</label> </div>
                                                    </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="input-group"> <input  name="cvcpwd" class="placeicon"value={ammount}  onChange={(e)=>{setammount(e.target.value)}} /> <label>AMOUNT</label> </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                      <button type="button" class="btn btn-outline-primary" onClick={()=>{changedata(e)}} disabled={!check_fields}>Send Amount</button>
                                                    <button type="button" class="btn btn-outline-primary" onClick={()=>{data_transfer(e)}}>View Amount</button>
