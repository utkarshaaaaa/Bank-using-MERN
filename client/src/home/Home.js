      ...
      <div>
            ...
            <div>
              <nav>
                ...
                <img
                  ...
                  width={70}
                  height={75}
                  style={{ borderRadius: "50px", alignContent: "center" }}
                />
                <ul>
        ...
        <div className="icons">
          <div className="icon">
            ...
            <div className="itens">Shopping</div>
          </div>

          <div className="icon">
            <LocalOfferIcon sx={{ fontSize: 40 }} />
            <div className="itens">Offers</div>
          </div>
          <div className="icon">
            <LocalMallIcon sx={{ fontSize: 40 }} />
            <div className="itens">Cart</div>
          </div>
          <div className="icon">
            <TvIcon sx={{ fontSize: 40 }} />
            <div className="itens">Electronics</div>
          </div>
          <div className="icon">
            <ModeOfTravelIcon sx={{ fontSize: 40 }} />
            <div className="itens">Travel</div>
          </div>
          <div className="icon">
            <MedicalInformationIcon sx={{ fontSize: 40 }} />
            <div className="itens">Medical</div>
          </div>
          <div className="icon">
            <PublicIcon sx={{ fontSize: 40 }} />
            <div className="itens">Connections</div>
          </div>
        </div>
        <br />
        <div class="container">
          <div class="row">
            <div class="col-sm-8">
              <div class="card">
                <img
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/EMI_logo.svg/1200px-EMI_logo.svg.png"
                  class="card-img-top"
                  alt="..."
                />
                <div class="card-body">
            ...
            <div class="col-sm-4">
              <div class="card">
                <img
                  src="https://img.freepik.com/free-vector/realistic-credit-card-design_23-2149126088.jpg?w=2000"
                  class="card-img-top"
                  alt="..."
                />
                <div class="card-body">
